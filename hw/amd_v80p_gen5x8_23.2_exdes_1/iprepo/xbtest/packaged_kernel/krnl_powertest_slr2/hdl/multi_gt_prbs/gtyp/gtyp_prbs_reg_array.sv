...
module gtyp_prbs_reg_array #(
    ...
    logic [3:0]  gt_txpolarity          = 'h0;
                                        ...
                                        // default extracted from GTYP example design
    logic [4:0]  gt_txpostcursor [3:0]  = '{default: '0};
    logic [4:0]  gt_txprecursor  [3:0]  = '{default: '0};
    logic [4:0]  gt_txdiffctrl   [3:0]  = '{default: 5'b11001};
    logic [6:0]  gt_txmaincursor [3:0]  = '{default: '0};
...
always_ff @(posedge ap_clk) begin
    ...
    if (cs && we && sel_core_reg) begin
        ...
        case (addr_5_0)
            ...
            default : begin
                $display("Illegal address sent to gtyp_reg_array");
            end
        endcase
