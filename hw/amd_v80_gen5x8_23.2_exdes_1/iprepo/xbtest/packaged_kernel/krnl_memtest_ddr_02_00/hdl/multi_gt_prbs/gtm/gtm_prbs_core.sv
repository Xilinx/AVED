...
module gtm_prbs_core #(
    ...
    input wire [23 : 0] txpostcursor,
    input wire [23 : 0] txprecursor,
    ...
    wire  [5:0]       lane_txpostcursor[0:3];
    wire  [5:0]       lane_txprecursor [0:3];
    ...
    assign lane_txpostcursor[0] = txpostcursor[5:0];
    assign lane_txpostcursor[1] = txpostcursor[11:6];
    assign lane_txpostcursor[2] = txpostcursor[17:12];
    assign lane_txpostcursor[3] = txpostcursor[23:18];
    assign lane_txprecursor[0] = txprecursor[5:0];
    assign lane_txprecursor[1] = txprecursor[11:6];
    assign lane_txprecursor[2] = txprecursor[17:12];
    assign lane_txprecursor[3] = txprecursor[23:18];

    wire [255:0] ch0_rxdata_ext;
    wire [255:0] ch1_rxdata_ext;
    wire [255:0] ch2_rxdata_ext;
    wire [255:0] ch3_rxdata_ext;
    assign rx_raw_data[0] = ch0_rxdata_ext[127:0];
    assign rx_raw_data[1] = ch1_rxdata_ext[127:0];
    assign rx_raw_data[2] = ch2_rxdata_ext[127:0];
    assign rx_raw_data[3] = ch3_rxdata_ext[127:0];


    gtm_xbtest_sub_gt_0_wrapper  u_gtm_quad (
        ...
        .ch0_txdata_ext                             ({128'b0,tx_raw_data[0]}),
        .ch1_rxdata_ext                             (ch1_rxdata_ext),
        .ch1_txdata_ext                             ({128'b0,tx_raw_data[1]}),
        .ch2_rxdata_ext                             (ch2_rxdata_ext),
        .ch2_txdata_ext                             ({128'b0,tx_raw_data[2]}),
        .ch3_rxdata_ext                             (ch3_rxdata_ext),
        .ch3_txdata_ext                             ({128'b0,tx_raw_data[3]}),
